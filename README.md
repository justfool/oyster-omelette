...
- 滑鼠停在上方玩家區（建材／作物／動物／農夫／卡片）會顯示細節。農夫區的 🙋 是「還能派工」。
- **I** 或 **D** 看目前選取格的細部說明（效果、累積量、誰佔用、要不要選農場格）。
- **資源列**分成建材、作物、動物、農夫、卡片；滑鼠移上去看數量說明與面前的牌。
...
犁田、建造柵欄、擴建農場、耕作：先選行動格再自動展開農場大圖，方向鍵選格後 Enter。仍可用列 1–3、行 1–5。
