...
SPACE_BLURBS = {
    "farm_expansion": "蓋房間（貼著既有房間；木屋 5 木+2 蘆）或蓋馬廄（2 木）。",
    "meeting_place": "成為起始玩家，下回合先放。之後可打 1 張次要發展。",
    "grain_seeds": "拿到 1 小麥。",
    "farmland": "犁 1 塊農田。第一塊任意空地，之後要相鄰。",
    "lessons": "打 1 張職業。2 人版第一張免費，之後 1 食。",
    "day_laborer": "拿到 2 食物。不堆疊。",
    "forest": "每回合補 3 木；拿走全部堆疊。",
    "clay_pit": "每回合補 1 磚頭；拿走全部堆疊。",
    "reed_bank": "每回合補 1 蘆葦；拿走全部堆疊。",
    "fishing": "每回合補 1 食物；拿走全部堆疊。",
    "grove_3p": "每回合補 2 木；拿走全部堆疊。3 人局。",
    "hollow_3p": "每回合補 1 磚頭；拿走全部堆疊。3 人局。",
    ...
    "hollow_4p": "每回合補 2 磚頭；拿走全部堆疊。4 人局。",
    ...
    "fences": "建造柵欄，木頭用到不能再圍。",
    "major_or_minor": "蓋 1 張主要發展，或打 1 張次要發展。",
    "sheep": "每回合補 1 綿羊；拿走全部堆疊。住不下可煮或跑掉。",
    "sow_and_or_bake": "播種且／或烤麵包。有火爐才能烤。",
    "family_growth": "自然生育（要空房）。之後可打 1 張次要發展。新生兒這回合不工作。",
    "western_quarry": "每回合補 1 石；拿走全部堆疊。",
    "vegetable_seeds": "拿到 1 蔬菜。",
    "wild_boar": "每回合補 1 野豬；拿走全部堆疊。",
    "renovation": "整棟房屋翻修（木→磚或磚→石），之後可再蓋主要或打次要發展。",
    "cattle": "每回合補 1 牛隻；拿走全部堆疊。",
    "eastern_quarry": "每回合補 1 石；拿走全部堆疊。",
    "plow_and_or_sow": "犁田且／或播種。",
    "family_growth_without_room": "沒空房也能生育。新生兒這回合不工作。",
    "renovation_and_fences": "先房屋翻修，木頭夠再建造柵欄。",
}
