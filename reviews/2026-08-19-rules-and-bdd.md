...
> 註（2026-08-20）：本檔第一次審核（下方 🔴／🟠／🟡／🔵 全文）與尾段「處理方式」都由同一個 Claude Opus 寫。第一次的 #2（3–4 人上課費用）把「主格 lessons」與「加格 lessons_3p／4p」混談、#6（餵食先烤麵包）憑印象腦補了規則書沒有的條文，兩條都在「處理方式」段自己糾回來。其餘判定不變。
